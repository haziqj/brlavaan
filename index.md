...
[brlavaan](https://github.com/haziqj/sem-bias) from
...
[brlavaan](https://github.com/haziqj/sem-bias) provides explicit and
implicit bias-reduction maximum likelihood estimation of latent variable
models that are [lavaan](https://lavaan.ugent.be) compatible. The main
functions are

1.  [`brsem()`](https://haziqj.ml/brlavaan/reference/brsem.md) for
    structural equation models.
2.  [`brcfa()`](https://haziqj.ml/brlavaan/reference/brcfa.md) for
    confirmatory factor analysis models.
3.  [`brgrowth()`](https://haziqj.ml/brlavaan/reference/brgrowth.md) for
    growth curve models.
4.  [`brlavaan()`](https://haziqj.ml/brlavaan/reference/brlavaan.md) for
    a more general interface to fit any model supported by
...
maximum likelihood methods provided by
[lavaan](https://lavaan.ugent.be).
