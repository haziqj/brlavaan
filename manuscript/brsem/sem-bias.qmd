...
experimental settings in @dhaene2022resampling, who have compared
their adaptations of the resampling-based methods in @sec-resampling
to SEMs to the alternative methods for bias correction in
@sec-alternative. In this way, we can perform a direct comparison of
the performance of RBM estimation with previously-proposed methods.
