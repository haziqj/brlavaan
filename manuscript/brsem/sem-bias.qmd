...
selection procedures apply directly, including those that are robust
to departures of the normality assumptions. For example, estimation of
standard errors for use in hypothesis tests or confidence intervals
...
(high). The third factor is the distribution of $\eta$ and $\epsilon$,
which we set to be either "normal", "kurtosis" or "non-normal".
