...
\thanks{CONTACT: $for(by-author)$$if(by-author.attributes.corresponding)$$if(by-author.email)$$by-author.name.literal$. Email: \href{mailto:$by-author.email$}{\nolinkurl{$by-author.email$}}. $endif$$endif$$endfor$}